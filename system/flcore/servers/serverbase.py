...
class Server(object):
    ...
    def aggregate_bases(self):
        ...
        for w, client_model in zip(self.uploaded_weights, self.uploaded_models):
            self.add_bases(w, client_model)

    def add_bases(self, w, client_model):
    ...
    def test_metrics(self):
        ...
        for c in self.clients:
            ct, ns, auc = c.test_metrics() # test_acc, test_num, auc
    ...
    def evaluate(self, acc=None, loss=None):
        stats = self.test_metrics() # ids, num_samples, tot_correct, tot_auc, 都是local的, 都是list
